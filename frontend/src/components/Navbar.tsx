...
const Navbar = () => {
  return (
    <div className='mt-3 max-h-16 px-2 flex justify-between pb-2 mb-4 border-b border-slate-500/10 '>
      ...
      <div className='border border-slate-500 rounded-full border-slate-500/10 hidden sm:block' >
        <div className="flex px-4 p-2 gap-2 items-center" >
          <input className="bg-transparent focus:outline-none   " placeholder='Serach' />
